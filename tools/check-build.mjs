...
const diff = execFileSync('git', ['status', '--porcelain', '--', 'guides', 'index.html'], { encoding: 'utf8' }).trim();
if (diff) {
...
console.log('  build is current: rebuilding changed nothing under guides/ or index.html');
